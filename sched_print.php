...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css2/sched_print.css">
...
<div class="row">
	...
	<div class="col-lg-5"></div>
	<div class="col-lg-2"><button type="submit" class="btn btn-primary" id="print" onclick="PrintDiv();">Print</button>
 ...
 <script src="printThis\printThis.js"></script>
	...
	<script>
		function PrintDiv() {
			...
			popupWin.document.write('<html><link rel=\"stylesheet\" href=\"css/bootstrap.min.css\" type=\"text/css\" media=\"all\"/><link rel=\"stylesheet\" href=\"css2/sched_print.css\" type=\"text/css\" media=\"print\"/><body onload="window.print()">'+ divToPrint.innerHTML +'</html>');
