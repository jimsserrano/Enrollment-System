...
<body>
  ...
  <div class="d-flex" id="wrapper">
    <div class="bg-dark border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="fees.php" class="list-group-item list-group-item-action mb-1 bg-white text-dark"><i class="fas fa-money-check-alt fa-lg"></i>Fees</a>
  ...
  <div class="modal fade" id="create_user" tabindex="-1" role="dialog" aria-labelledby="modallabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modallabel">Add Fee</h5>
      ...
      <div class="modal-body">
        ...
        <form method="post">
         ...
         <div class="row">
          ...
          <div class="col-lg-4"><button class="btn btn-primary btn-block" type="submit" name="add_fee">Add</button></div> 
        </div></form>
  ...
  <table class="table table-striped table-bordered">
    ...
    <?php
  $data="SELECT * FROM tbl_fee";

  $qry=mysqli_query($conn,$data) or die ("Could not execute Query.".mysql_error());
    while($data2=mysqli_fetch_assoc($qry)){
  ?>
    <tr>
      <td><?php echo $data2['fee_name']?></td>
      <td><?php echo "₱",number_format($data2['fee_price'],2)?></td>
      <td><button class="btn btn-primary btn-block" name="edit" data-toggle="modal" data-target="#edit_fee<?php echo $data2['fee_id']?>" id="edit">Edit</button>
      <button class="btn btn-warning btn-block" name="delete_course" data-toggle="modal" data-target="#fee_delete<?php echo $data2['fee_id']?>">Delete</button></td>
